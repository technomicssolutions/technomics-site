...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Candidate.name'
        db.alter_column(u'web_candidate', 'name', self.gf('django.db.models.fields.CharField')(max_length=150))
        ...
        # Changing field 'Candidate.email'
        db.alter_column(u'web_candidate', 'email', self.gf('django.db.models.fields.EmailField')(max_length=120))
        # Adding field 'Vacancy.description'
        db.add_column(u'web_vacancy', 'description',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Candidate.name'
        db.alter_column(u'web_candidate', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # User chose to not deal with backwards NULL issues for 'Candidate.resume'
        raise RuntimeError("Cannot reverse this migration. 'Candidate.resume' and its values cannot be restored.")

        # Changing field 'Candidate.email'
        db.alter_column(u'web_candidate', 'email', self.gf('django.db.models.fields.EmailField')(max_length=100))
        # Deleting field 'Vacancy.description'
        db.delete_column(u'web_vacancy', 'description')
    ...
    models = {
        ...
        u'web.candidate': {
            ...
            'vacancy': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['web.Vacancy']", 'null': 'True', 'blank': 'True'})
        },
        u'web.comment': {
