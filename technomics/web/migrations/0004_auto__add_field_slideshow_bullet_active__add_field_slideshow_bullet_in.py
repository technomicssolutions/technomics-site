...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Slideshow.bullet_active'
        db.add_column(u'web_slideshow', 'bullet_active',
                      self.gf('django.db.models.fields.files.ImageField')(default=' ', max_length=100),
                      keep_default=False)

        # Adding field 'Slideshow.bullet_inactive'
        db.add_column(u'web_slideshow', 'bullet_inactive',
                      self.gf('django.db.models.fields.files.ImageField')(default=' ', max_length=100),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Slideshow.bullet_active'
        db.delete_column(u'web_slideshow', 'bullet_active')

        # Deleting field 'Slideshow.bullet_inactive'
        db.delete_column(u'web_slideshow', 'bullet_inactive')
