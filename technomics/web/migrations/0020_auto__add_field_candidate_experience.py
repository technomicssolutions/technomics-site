...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Candidate.experience'
        db.add_column(u'web_candidate', 'experience',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=20),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Candidate.experience'
        db.delete_column(u'web_candidate', 'experience')
