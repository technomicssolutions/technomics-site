...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Aboutus.left_content'
        db.add_column(u'web_aboutus', 'left_content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Aboutus.right_content'
        db.add_column(u'web_aboutus', 'right_content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Aboutus.left_content'
        db.delete_column(u'web_aboutus', 'left_content')

        # Deleting field 'Aboutus.right_content'
        db.delete_column(u'web_aboutus', 'right_content')
