...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submenu.order'
        db.add_column(u'web_submenu', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default='1', max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Menu.order'
        db.add_column(u'web_menu', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default='1', max_length=10, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Submenu.order'
        db.delete_column(u'web_submenu', 'order')

        # Deleting field 'Menu.order'
        db.delete_column(u'web_menu', 'order')
