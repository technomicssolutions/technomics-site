...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'web_candidate', (
            (u'dates_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['web.Dates'], unique=True, primary_key=True)),
            ('resume', self.gf('django.db.models.fields.files.FileField')(max_length=20000, blank=True)),
        ))
        db.send_create_signal(u'web', ['Candidate'])
        ...
        db.create_table(u'web_vacancy', (
            (u'dates_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['web.Dates'], unique=True, primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('no_of_vacancy', self.gf('django.db.models.fields.IntegerField')(default='0', max_length=10, null=True, blank=True)),
            ('opening_date', self.gf('django.db.models.fields.DateField')()),
            ('closing_date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal(u'web', ['Vacancy'])
    ...
    models = {
        ...
        u'web.candidate': {
            ...
            u'dates_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['web.Dates']", 'unique': 'True', 'primary_key': 'True'}),
            'resume': ('django.db.models.fields.files.FileField', [], {'max_length': '20000', 'blank': 'True'})
        },
        u'web.comment': {
        ...
        u'web.experienced': {
            'Meta': {'object_name': 'Experienced', '_ormbases': [u'web.Candidate']},
            u'candidate_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['web.Candidate']", 'unique': 'True', 'primary_key': 'True'}),
            'candidate_type': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        u'web.feature': {
        ...
        u'web.freshers': {
            'Meta': {'object_name': 'Freshers', '_ormbases': [u'web.Candidate']},
