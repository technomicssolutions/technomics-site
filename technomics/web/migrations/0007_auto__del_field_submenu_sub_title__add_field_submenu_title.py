...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Submenu.sub_title'
        db.delete_column(u'web_submenu', 'sub_title')

        # Adding field 'Submenu.title'
        db.add_column(u'web_submenu', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Submenu.sub_title'
        db.add_column(u'web_submenu', 'sub_title',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Submenu.title'
        db.delete_column(u'web_submenu', 'title')
