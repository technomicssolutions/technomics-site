...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'web_comment', 'author')

        # Deleting field 'Blog.author'
        db.delete_column(u'web_blog', 'author')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Blog.author'
        raise RuntimeError("Cannot reverse this migration. 'Blog.author' and its values cannot be restored.")
    models = {
        u'web.aboutus': {
